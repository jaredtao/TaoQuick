...
class BIZCOMMON_EXPORT QQuickTreeViewStyleHints : public QObject
{
    Q_OBJECT
...
class BIZCOMMON_EXPORT QQuickTreeView : public QQuickTableView
{
    Q_OBJECT
...
class BIZCOMMON_EXPORT QQuickTreeViewAttached : public QQuickTableViewAttached
{
    Q_OBJECT
...
public:
    QQuickTreeViewAttached(QObject *parent)
        : QQuickTableViewAttached(parent)
    {
    }
    QQuickTreeView *view() const
    {
        return m_view;
    }
    void setView(QQuickTreeView *view)
    {
        m_view = view;
    };

...
function Main {
    ...
    # write qmldir
    Get-ChildItem -Recurse . -Exclude designer -Filter *.qml  | ForEach-Object -Process {
        WriteQmlDirLine $_
    }
    # clear qrc
    ...
    WriteQrcBegin
    # write qrc content
    Get-ChildItem -Recurse . -Filter *.qml | ForEach-Object -Process {
        WriteQrcLine $_
    }
    Get-ChildItem -Recurse . -Exclude ./designer/images/*.png -Filter *.png | ForEach-Object -Process {
        WriteQrcLine $_
    }
    Get-ChildItem -Recurse . -Exclude ./designer/images/*.jpg -Filter *.jpg | ForEach-Object -Process {
        WriteQrcLine $_
    }
    # write qrc tail
    WriteQrcEnd
